...
public class MqPayNotify {
    ...
    private static final MyLog _log = MyLog.getLog(MqPayNotify.class);

    public void send(String msg) {
        _log.info("发送MQ消息:msg={}", msg);
        this.rabbitTemplate.convertAndSend(MqConfig.PAY_NOTIFY_QUEUE_NAME, msg);
    }
    ...
    public void send(String msg, long delay) {
        ...
        rabbitTemplate.convertAndSend(MqConfig.PAY_NOTIFY_QUEUE_NAME, msg,(message -> {
