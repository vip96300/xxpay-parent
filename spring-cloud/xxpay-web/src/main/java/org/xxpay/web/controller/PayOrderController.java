...
public class PayOrderController {
    ...
    public String payOrder(@RequestParam String params) {
        ...
        try {
            ...
            if(resObj == null || org.springframework.util.StringUtils.isEmpty(resObj.getString("result"))) return XXPayUtil.makeRetFail(XXPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "创建支付订单失败", null, null));
