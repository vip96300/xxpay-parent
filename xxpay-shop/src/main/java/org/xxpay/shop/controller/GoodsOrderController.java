...
public class GoodsOrderController {
    ...
    static final String mchId = "100000001";
    // 加签key
    ...
    static final String baseUrl = "http://192.168.0.105:9011/api-xxpay";
    //static final String notifyUrl = "http://shop.xxpay.org/goods/payNotify";
    static final String notifyUrl = "http://192.168.0.126:8081/goods/payNotify";
    ...
    public String buy(@PathVariable("goodsId") String goodsId) {
        ...
        String goodsOrderId =System.nanoTime()+"";
        System.err.println(goodsOrderId);
    ...
    public String pay(@PathVariable("goodsOrderId") String goodsOrderId) {
        ...
        paramMap.put("channelId", "ALIPAY_MOBILE");             // 支付渠道ID, WX_NATIVE,ALIPAY_WAP
        ...
        String reqData = "params=" + URLEncoder.encode(paramMap.toJSONString());
